(function(){
  ...
  const quality=document.createElement('div');quality.className='quality-levels';quality.setAttribute('aria-label','Good, Better and Best');quality.innerHTML='<span>Good</span><span>Better</span><strong>Best</strong>';document.body.prepend(quality);
