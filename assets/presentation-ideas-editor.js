(function(){
  ...
  const ALL_OUTPUTS = ['website','audio','video','pdf','powerpoint','documents','infographic','backgrounds','credits','postcredits'];
  ...
  outputPanel.innerHTML = '<div class="panel-h"><div><h2>¿Qué queremos obtener?</h2><p class="sub">La presentación, los créditos y los postcréditos se preparan en AdmiraNeXT. Las imágenes de fondo forman un paquete aparte, sin texto y compartido por todos los idiomas.</p></div></div><div class="output-grid"><label class="output"><input type="checkbox" name="output" value="website"><b>01</b><span>Website</span></label><label class="output"><input type="checkbox" name="output" value="audio"><b>02</b><span>Audio</span></label><label class="output"><input type="checkbox" name="output" value="video"><b>03</b><span>Vídeo</span></label><label class="output"><input type="checkbox" name="output" value="pdf"><b>04</b><span>PDF</span></label><label class="output"><input type="checkbox" name="output" value="powerpoint"><b>05</b><span>PowerPoint</span></label><label class="output"><input type="checkbox" name="output" value="documents"><b>06</b><span>Documento de trabajo</span></label><label class="output"><input type="checkbox" name="output" value="infographic"><b>07</b><span>Infografía</span></label><label class="output"><input type="checkbox" name="output" value="backgrounds"><b>08</b><span>Imágenes de fondo</span></label><label class="output"><input type="checkbox" name="output" value="credits"><b>09</b><span>Créditos</span></label><label class="output"><input type="checkbox" name="output" value="postcredits"><b>10</b><span>Postcréditos</span></label><label class="output all"><input type="checkbox" id="allOutputs"><b>11</b><span>Todo</span></label></div>';
