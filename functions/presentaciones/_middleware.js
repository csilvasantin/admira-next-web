...
async function injectTelemetry(response, inlineEditor = false){
  ...
  const editor = inlineEditor ? '<script>window.__ADMIRA_CAN_EDIT__=true</script><script src="/assets/presentation-inline-editor.js?v=20260902-1"></script>' : '';
