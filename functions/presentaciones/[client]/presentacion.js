...
export async function onRequestGet(context){
  ...
  let html=`<!doctype html><html lang="${esc(languages[0]||'es')}" data-quality="${calidadSala}" data-mode="${mode}" data-layout="${layout}" data-profile="${profile}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>${name} · Presentación</title><style>
  ...
  html=html.replace('</head>',`<style>${responsiveGoodCss}${responsiveDetailCss}${brandIdentityCss}${printCss}</style></head>`);
