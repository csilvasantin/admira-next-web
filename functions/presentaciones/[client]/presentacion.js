...
export async function onRequestGet(context){
  ...
  </style><style>html[data-quality="good"]{--primary:#e9ece2;--accent:#789b3a;--bg:#f7f8f3;--surface:#fff;--ink:#18212a;--sans:Inter,-apple-system,"Segoe UI",Arial,sans-serif}html[data-quality="better"]{--primary:#12233e;--accent:#ffb000;--bg:#07101b;--surface:#111827;--ink:#f8fbff;--sans:Inter,-apple-system,"Segoe UI",Arial,sans-serif}html[data-quality="good"] .slide:not(.deck-slide){background:linear-gradient(135deg,#fff,#edf0e7)}html[data-quality="good"] .slide:not(.deck-slide):after{border-color:rgba(120,155,58,.13)}html[data-quality="better"] .slide:not(.deck-slide){background:radial-gradient(90% 80% at 85% 0%,rgba(255,176,0,.24),transparent 62%),linear-gradient(145deg,#12233e,#07101b)}html[data-quality="good"] .slide[data-has-image="true"]:before{display:none}html[data-quality="better"] .slide[data-has-image="true"]:before{display:block}html[data-quality="best"]{--primary:#0b1220;--accent:#ffbe2e;--bg:#05080f;--surface:#101826;--ink:#f7fafc;--sans:"Iowan Old Style",Georgia,"Times New Roman",serif}html[data-quality="best"] .slide:not(.deck-slide){background:radial-gradient(90% 80% at 12% 0%,rgba(255,190,46,.18),transparent 58%),linear-gradient(155deg,#101826,#05080f)}.best-figure{display:none;margin:0;padding:0;border:0}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"]{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(260px,.92fr);align-items:center;justify-items:stretch;gap:clamp(18px,3.5vw,48px);padding:8vh 5vw;place-items:unset}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"]:before{display:block;filter:saturate(.78) brightness(.42) contrast(1.05);transform:scale(1.04);background-image:linear-gradient(115deg,rgba(5,8,15,.88) 0%,rgba(5,8,15,.55) 46%,rgba(5,8,15,.22) 100%),var(--slide-image)}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .best-figure{display:flex;align-items:center;justify-content:center;position:relative;z-index:2;width:100%;height:100%;order:2}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .inner{order:1;z-index:3;width:min(640px,100%);max-width:none;padding:clamp(22px,3.2vw,42px);border:1px solid rgba(255,255,255,.14);border-radius:calc(var(--radius) + 18px);background:linear-gradient(160deg,rgba(16,24,38,.82),rgba(8,12,20,.68));box-shadow:0 24px 80px rgba(0,0,0,.45);backdrop-filter:blur(16px)}html[data-quality="best"] .best-figure img{display:block;width:min(100%,540px);height:auto;max-height:min(72vh,640px);aspect-ratio:4/5;object-fit:cover;border-radius:calc(var(--radius) + 22px);border:1px solid rgba(255,255,255,.16);box-shadow:0 28px 70px rgba(0,0,0,.55),0 0 0 1px rgba(255,190,46,.12)}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] h1,html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] h2,html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .close strong{font-size:clamp(34px,5.4vw,72px);line-height:1.02;letter-spacing:-.035em;text-wrap:balance;max-width:18ch}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .message{font-size:clamp(18px,2.1vw,28px);line-height:1.28;font-weight:650;max-width:34ch;margin-top:22px;color:rgba(247,250,252,.92)}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .detail,html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .close span,html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] #coverSummary{font-size:clamp(14px,1.35vw,18px);line-height:1.55;max-width:42ch;margin-top:18px;color:rgba(247,250,252,.68)}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .num,html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .eyebrow{margin-bottom:18px;letter-spacing:.16em}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"]:after{display:none}@media(max-width:900px){html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"]{grid-template-columns:1fr;padding:7vh 7vw 8vh}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .best-figure{order:1;max-height:38vh}html[data-quality="best"] .slide:not(.deck-slide)[data-has-image="true"] .inner{order:2}html[data-quality="best"] .best-figure img{max-height:34vh;aspect-ratio:16/10;width:100%}}.deck-slide,.slide{transition:background .35s,color .35s}.deck-best .deck-copy h2{font-family:var(--sans);font-weight:750}.deck-best .deck-kicker{color:var(--accent)}html[data-quality="best"] .deck-best img{filter:saturate(.94) contrast(1.08) brightness(.66)}.section-nav{position:fixed;z-index:20;left:50%;top:18px;transform:translateX(-50%);display:flex;gap:3px;padding:4px;border:1px solid color-mix(in srgb,var(--ink) 15%,transparent);border-radius:999px;background:color-mix(in srgb,var(--surface) 78%,transparent);backdrop-filter:blur(12px)}.section-nav button{display:flex;align-items:center;gap:7px;border:0;border-radius:999px;padding:8px 11px;background:transparent;color:color-mix(in srgb,var(--ink) 64%,transparent);font:750 10px/1 var(--sans);cursor:pointer;white-space:nowrap}.section-nav button b{font:800 9px/1 var(--mono);color:var(--accent)}.section-nav button[aria-pressed="true"]{background:var(--accent);color:var(--bg)}.section-nav button[aria-pressed="true"] b{color:inherit}.section-nav button:disabled{display:none}@media(max-width:1050px){.section-nav button{padding:9px}.section-nav button span{display:none}}@media(max-width:650px){.section-nav{top:auto;bottom:14px}.section-nav button{padding:8px 10px}}</style></head><body><div class="languages" aria-label="Idiomas">${buttons}</div><nav class="section-nav" aria-label="Segmentos de la presentación">${sectionNav}</nav>${beforeSlides}<section class="slide cover"${mediaFor('cover')?' data-slide-media':''} data-slide-key="cover" data-segment="proposal" data-section="proposal" data-image-index="0"${imageAttr(0)}>${mediaFor('cover')}<figure class="best-figure" aria-hidden="true"><img alt="" loading="lazy"></figure><div class="inner"><span class="eyebrow" data-edit-field="hero.eyebrow">${esc(heroInicial?.eyebrow||`ADmiraNeXT × ${config.displayName}`)}</span><h1 id="coverTitle" data-edit-field="hero.title">${esc(heroInicial?.title)}</h1><p class="detail" id="coverSummary" data-edit-field="hero.summary">${esc(heroInicial?.summary)}</p></div></section><section class="slide"${mediaFor('objective')?' data-slide-media':''} data-slide-key="objective" data-segment="proposal" data-section="proposal" data-image-index="1"${imageAttr(1)}>${mediaFor('objective')}<figure class="best-figure" aria-hidden="true"><img alt="" loading="lazy"></figure><div class="inner"><span class="eyebrow" id="objectiveLabel" data-edit-field="labels.objective">${esc(etiquetasIniciales?.objective||locales.es.labels.objective)}</span><h2 id="objectiveText" data-edit-field="objective">${esc(objetivoInicial)}</h2></div></section>${slides}${embedSlides}<section class="slide"${mediaFor('closing')?' data-slide-media':''} data-slide-key="closing" data-segment="proposal" data-section="proposal" data-image-index="${baseBlocks.length+2}"${imageAttr(baseBlocks.length+2)}>${mediaFor('closing')}<figure class="best-figure" aria-hidden="true"><img alt="" loading="lazy"></figure><div class="inner close"><span class="eyebrow" id="nextLabel" data-edit-field="labels.next">${esc(etiquetasIniciales?.next||locales.es.labels.next)}</span><strong id="closingTitle" data-edit-field="closing.title">${esc(cierreInicial?.title)}</strong><span id="closingAction" data-edit-field="closing.action">${esc(cierreInicial?.action)}</span></div></section>${afterSlides}<div class="nav" id="sequenceNav">↑ ↓ · F pantalla completa</div><script>
  ...
  function syncBestFigures(){document.querySelectorAll('.slide[data-image-index]').forEach(slide=>{const figure=slide.querySelector('.best-figure img');if(!figure)return;const raw=(slide.style.getPropertyValue('--slide-image')||'').trim();let url='';if(raw.startsWith('url(')&&raw.endsWith(')')){url=raw.slice(4,-1).trim();if((url.startsWith('"')&&url.endsWith('"'))||(url.startsWith("'")&&url.endsWith("'")))url=url.slice(1,-1)}if(url&&presentationState.quality==='best'&&slide.dataset.hasImage==='true'){if(figure.getAttribute('src')!==url)figure.setAttribute('src',url);figure.hidden=false}else{figure.removeAttribute('src');figure.hidden=true}})}
