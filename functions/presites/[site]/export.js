...
export async function onRequestGet({params,env}){
  ...
  return new Response(renderPresite(site),{headers:{'content-type':'text/html; charset=utf-8','content-disposition':`attachment; filename="${slugify(site.displayName)}-intro.html"`,'cache-control':'no-store'}});
}
