...
export async function onRequestGet({request,env}) {
  ...
  return Response.json({ok:true,user:{email:current.email,display_name:current.display_name,role:current.role},csrf:current.csrf},{headers:{'cache-control':'no-store'}});
}
